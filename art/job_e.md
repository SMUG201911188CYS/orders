...
=== CARDS ===
CARD A -> D:/Claude/nan2026/orders/art/concepts/v4/char_09_shizu.png
  Shizu, SUPPORT. Concept: KUUDERE — records every violation without a word; never seen angry.
  POSE: absolutely motionless, standing straight, only the head tipped slightly to one side.
  CARRIES: a thick stack of documents cradled in one arm; a large rubber stamp raised in the
  other hand at chest height, as if about to bring it down.
  UNIFORM WORN AS: buttoned all the way to the throat; sleeves folded to an exact width.
  ACCESSORIES: a red ink-pad case on a cord at her neck.
  FACE: very long straight white hair falling to around the knees, making a tall narrow mass.
  Keep her neck and jawline visible rather than fully curtained. Narrow elongated eyes,
  pale grey irises, almost no highlights, completely blank expression.
