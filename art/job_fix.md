...
(not merely read):
  D:/Claude/nan2026/orders/art/concepts/v4/char_04_yui.png
...
CARD A -> D:/Claude/nan2026/orders/art/concepts/v4/char_05_mio.png
  ...
  WHY THIS IS BEING REDONE: her old card kept an older, shorter, larger-headed build while the
  rest of the set moved to the taller build seen in Image 1. She is now the odd one out.
  Match Image 1's build exactly — same head-to-body ratio, same leg length, same figure height,
  same feet position. Only her identity changes.
  POSE: relaxed slouch, back slightly rounded, weight on one leg, one hand pushed into a pocket.
  Noticeably more slumped than Image 1's upright stance, but the SAME body build.
  CARRIES: a folded camera tripod resting across one shoulder as a long diagonal.
  UNIFORM WORN AS: collar turned up over the neck.
  ACCESSORIES: large over-ear headphones around the neck; a small foil energy-jelly pouch held
  in the corner of her mouth.
  FACE: jet-black chin-length bob with a blunt fringe. Heavy half-lidded eyes, clear dark circles
  underneath, the smallest eye highlights of the whole cast, completely blank expression.
  ROLE: keep the brass waist belt, brass-buckled hip pouches and brass collar tab.
  No vest, nothing hi-vis, no teal, no rose. Remove Image 1's lenses, monocular and record cards.
...
CARD B -> D:/Claude/nan2026/orders/art/concepts/v4/char_02_hana.png
  ...
  WHY THIS IS BEING REDONE: her old card draped a fire blanket over BOTH shoulders like a full
  cape. It inflated her torso into a huge shapeless block that no longer matched the cast.
  Keep her calm, immovable character, but make the silhouette read as a person again.
  Match Image 1's build exactly — same head-to-body ratio, leg length, figure height, feet position.
  POSE: standing still, weight settled back, arms folded across the chest. Calm and immovable,
  but a NORMAL slim standing silhouette — not a wide bulky mass.
  UNIFORM WORN AS: a folded fire blanket slung over ONE shoulder only, hanging down her side
  like a strap or a towel. It must NOT wrap around the body, must NOT flare outward, and must
  NOT widen her torso. Her waist and hips stay visible and normally proportioned.
  ACCESSORIES: a battered analogue wristwatch; heavy flame-resistant gloves.
  FACE: long straight DEEP PLUM hair past the shoulders — clearly plum/wine, not brown or navy.
  Calm, unbothered, half-lidded eyes with downturned outer corners, gaze angled slightly down.
  ROLE: bright hi-vis YELLOW-GREEN safety vest with reflective grey stripes over the navy uniform,
  plus TEAL (#6cc2cf) shoulder epaulettes on both shoulders. No brass anywhere.
  Remove Image 1's lenses, monocular, record cards and brass belt.
